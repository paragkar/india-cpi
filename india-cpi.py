...
if selected_sector_type == "All" and not selected_description:
   ...
   # Update the layout for the combined figure
    ...
    if selected_metric_type == "Inflation":
        fig.update_xaxes(row=1, col=2, range=[min_weighted_avg*2, max_weighted_avg * 1.4],fixedrange=True, showline=True, linewidth=1.5, linecolor='grey', mirror=True, showgrid=True, gridcolor='lightgrey')
    else:
